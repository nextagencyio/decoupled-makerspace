...
import workshopsData from '@/data/mock/workshops.json'
import equipmentsData from '@/data/mock/equipment.json'
...
const mockDataMap: Record<string, any> = {
  ...
  'workshops.json': workshopsData,
  'equipment.json': equipmentsData,
...
export function handleMockQuery(body: string): any {
  try {
    ...
    if (query.includes('GetWorkshops') || query.includes('nodeWorkshops')) {
