      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-18 py-3">
          ...
          <div className="flex items-center space-x-4">
            <Link
              href="/contact"
              className="hidden sm:inline-flex items-center bg-accent-500 text-white px-6 py-2.5 rounded-full hover:bg-accent-400 transition-all duration-200 font-bold text-sm shadow-md shadow-accent-200 hover:shadow-lg hover:shadow-accent-200 hover:-translate-y-0.5"
            >
              Start Making
            </Link>
          ...
          <div className="lg:hidden border-t-2 border-primary-100 py-4">
            <nav className="flex flex-col space-y-2">
              ...
              <Link
                href="/contact"
                onClick={() => setMobileMenuOpen(false)}
                className="px-5 py-3 rounded-full text-sm font-bold bg-accent-500 text-white hover:bg-accent-400 text-center"
              >
                Start Making
              </Link>
            </nav>
