...
export const metadata: Metadata = {
  title: 'Events | The Tinker Lab',
  description: 'Discover our upcoming maker events.',
}
      ...
      <section className="relative bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800 text-white py-16 md:py-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl text-primary-100 max-w-3xl mx-auto">Community gatherings, maker fairs, and special happenings.</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {items.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {items.map((item: any) => (<EventCard key={item.id} item={item} />))}
            </div>
          )}
        </div>
      </section>
